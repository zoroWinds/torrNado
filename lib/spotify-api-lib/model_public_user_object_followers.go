...
// checks if the PublicUserObjectFollowers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicUserObjectFollowers{}

// PublicUserObjectFollowers Information about the followers of this user. 
type PublicUserObjectFollowers struct {
...
func NewPublicUserObjectFollowers() *PublicUserObjectFollowers {
	this := PublicUserObjectFollowers{}
	return &this
}
...
func (o *PublicUserObjectFollowers) SetHrefNil() {
	o.Href.Set(nil)
}
...
func (o PublicUserObjectFollowers) MarshalJSON() ([]byte, error) {
...
func (o PublicUserObjectFollowers) ToMap() (map[string]interface{}, error) {
...
type NullablePublicUserObjectFollowers struct {
	value *PublicUserObjectFollowers
	isSet bool
}

func (v NullablePublicUserObjectFollowers) Get() *PublicUserObjectFollowers {
	return v.value
}

func (v *NullablePublicUserObjectFollowers) Set(val *PublicUserObjectFollowers) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicUserObjectFollowers) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicUserObjectFollowers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicUserObjectFollowers(val *PublicUserObjectFollowers) *NullablePublicUserObjectFollowers {
	return &NullablePublicUserObjectFollowers{value: val, isSet: true}
}

func (v NullablePublicUserObjectFollowers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicUserObjectFollowers) UnmarshalJSON(src []byte) error {
	v.isSet = true

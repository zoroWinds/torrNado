...
// checks if the ContextObjectExternalUrls type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextObjectExternalUrls{}

// ContextObjectExternalUrls External URLs for this context.
...
func NewContextObjectExternalUrls() *ContextObjectExternalUrls {
	this := ContextObjectExternalUrls{}
	return &this
}
...
func (o ContextObjectExternalUrls) MarshalJSON() ([]byte, error) {
...
func (o ContextObjectExternalUrls) ToMap() (map[string]interface{}, error) {
...
type NullableContextObjectExternalUrls struct {
	value *ContextObjectExternalUrls
	isSet bool
}

func (v NullableContextObjectExternalUrls) Get() *ContextObjectExternalUrls {
	return v.value
}

func (v *NullableContextObjectExternalUrls) Set(val *ContextObjectExternalUrls) {
	v.value = val
	v.isSet = true
}

func (v NullableContextObjectExternalUrls) IsSet() bool {
	return v.isSet
}

func (v *NullableContextObjectExternalUrls) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContextObjectExternalUrls(val *ContextObjectExternalUrls) *NullableContextObjectExternalUrls {
	return &NullableContextObjectExternalUrls{value: val, isSet: true}
}

func (v NullableContextObjectExternalUrls) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContextObjectExternalUrls) UnmarshalJSON(src []byte) error {
	v.isSet = true

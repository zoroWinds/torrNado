...
// checks if the PlaylistObjectTracks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlaylistObjectTracks{}

// PlaylistObjectTracks The tracks of the playlist. 
...
func (o PlaylistObjectTracks) MarshalJSON() ([]byte, error) {
...
func (o PlaylistObjectTracks) ToMap() (map[string]interface{}, error) {
...
type NullablePlaylistObjectTracks struct {
	value *PlaylistObjectTracks
	isSet bool
}

func (v NullablePlaylistObjectTracks) Get() *PlaylistObjectTracks {
	return v.value
}

func (v *NullablePlaylistObjectTracks) Set(val *PlaylistObjectTracks) {
	v.value = val
	v.isSet = true
}

func (v NullablePlaylistObjectTracks) IsSet() bool {
	return v.isSet
}

func (v *NullablePlaylistObjectTracks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlaylistObjectTracks(val *PlaylistObjectTracks) *NullablePlaylistObjectTracks {
	return &NullablePlaylistObjectTracks{value: val, isSet: true}
}

func (v NullablePlaylistObjectTracks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlaylistObjectTracks) UnmarshalJSON(src []byte) error {
	v.isSet = true

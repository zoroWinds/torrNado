...
// checks if the TrackObjectExternalIds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrackObjectExternalIds{}

// TrackObjectExternalIds Known external IDs for the track. 
type TrackObjectExternalIds struct {
...
func (o TrackObjectExternalIds) MarshalJSON() ([]byte, error) {
...
func (o TrackObjectExternalIds) ToMap() (map[string]interface{}, error) {
...
type NullableTrackObjectExternalIds struct {
	value *TrackObjectExternalIds
	isSet bool
}

func (v NullableTrackObjectExternalIds) Get() *TrackObjectExternalIds {
	return v.value
}

func (v *NullableTrackObjectExternalIds) Set(val *TrackObjectExternalIds) {
	v.value = val
	v.isSet = true
}

func (v NullableTrackObjectExternalIds) IsSet() bool {
	return v.isSet
}

func (v *NullableTrackObjectExternalIds) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrackObjectExternalIds(val *TrackObjectExternalIds) *NullableTrackObjectExternalIds {
	return &NullableTrackObjectExternalIds{value: val, isSet: true}
}

func (v NullableTrackObjectExternalIds) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrackObjectExternalIds) UnmarshalJSON(src []byte) error {
	v.isSet = true

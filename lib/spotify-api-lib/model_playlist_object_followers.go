...
// checks if the PlaylistObjectFollowers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlaylistObjectFollowers{}

// PlaylistObjectFollowers Information about the followers of the playlist.
type PlaylistObjectFollowers struct {
...
func (o *PlaylistObjectFollowers) SetHrefNil() {
	o.Href.Set(nil)
}
...
func (o PlaylistObjectFollowers) MarshalJSON() ([]byte, error) {
...
func (o PlaylistObjectFollowers) ToMap() (map[string]interface{}, error) {
...
type NullablePlaylistObjectFollowers struct {
	value *PlaylistObjectFollowers
	isSet bool
}

func (v NullablePlaylistObjectFollowers) Get() *PlaylistObjectFollowers {
	return v.value
}

func (v *NullablePlaylistObjectFollowers) Set(val *PlaylistObjectFollowers) {
	v.value = val
	v.isSet = true
}

func (v NullablePlaylistObjectFollowers) IsSet() bool {
	return v.isSet
}

func (v *NullablePlaylistObjectFollowers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlaylistObjectFollowers(val *PlaylistObjectFollowers) *NullablePlaylistObjectFollowers {
	return &NullablePlaylistObjectFollowers{value: val, isSet: true}
}

func (v NullablePlaylistObjectFollowers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlaylistObjectFollowers) UnmarshalJSON(src []byte) error {
	v.isSet = true
